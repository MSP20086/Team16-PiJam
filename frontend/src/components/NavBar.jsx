...
import React, { useState, useEffect } from 'react';
import { Menu, X, ChevronDown, User, LogIn, Home, FileText, Award, PlusCircle, BarChart2, Gift, Music, Sun, Moon } from 'lucide-react';
...
const Navbar = () => {
  ...
  // New role switching functions for demo
            ...
            {!isLoggedIn ? (
              ...
              <div className="relative group">
                ...
                <div className={`origin-top-right absolute right-0 mt-2 w-48 rounded-lg shadow-lg py-1 focus:outline-none hidden group-hover:block z-10 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                  ...
                  {/* Role switching buttons for demo */}
                  <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-700">
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Demo Mode:</p>
                    <div className="flex space-x-2">
                      <button
                        onClick={switchToStudent}
                        className={`px-2 py-1 text-xs rounded-md ${userRole === ROLE.STUDENT ? 'bg-pink-100 text-pink-700 dark:bg-pink-900 dark:text-pink-300' : 'bg-gray-100 hover:bg-pink-50 dark:bg-gray-700 dark:hover:bg-gray-600'}`}
                      >
                        Student View
                      </button>
                      <button
                        onClick={switchToTeacher}
                        className={`px-2 py-1 text-xs rounded-md ${userRole === ROLE.TEACHER ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300' : 'bg-gray-100 hover:bg-blue-50 dark:bg-gray-700 dark:hover:bg-gray-600'}`}
                      >
                        Teacher View
                      </button>
                    </div>
        ...
        <div className="pt-4 pb-3 border-t border-gray-200 dark:border-gray-700">
          {!isLoggedIn ? (
            ...
            <>
              ...
              {/* Mobile role switching buttons for demo */}
              <div className="mt-3 px-5 py-2 border-t border-b border-gray-200 dark:border-gray-700">
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">Demo Mode:</p>
                <div className="flex space-x-2">
                  <button
                    onClick={switchToStudent}
                    className={`px-3 py-1 text-sm rounded-md ${userRole === ROLE.STUDENT ? 'bg-pink-100 text-pink-700 dark:bg-pink-900 dark:text-pink-300' : 'bg-gray-100 hover:bg-pink-50 dark:bg-gray-700 dark:hover:bg-gray-600'}`}
                  >
                    Student View
                  </button>
                  <button
                    onClick={switchToTeacher}
                    className={`px-3 py-1 text-sm rounded-md ${userRole === ROLE.TEACHER ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300' : 'bg-gray-100 hover:bg-blue-50 dark:bg-gray-700 dark:hover:bg-gray-600'}`}
                  >
                    Teacher View
                  </button>
                </div>
